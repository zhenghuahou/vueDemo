...
var getLocations = {
    ...
    position: function(d) {
        ...
        var url = '//api.map.baidu.com/geoconv/v1/?coords=' + href + '&from=1&to=5&ak=D5b939310cda4811e6587c8a535e1edc&services';
        $.ajax({
            type: "GET",
            dataType: "jsonp",
            url: url,
            success: function(res) {
                ...
                var url2 = "//api.map.baidu.com/geocoder/v2/?ak=D5b939310cda4811e6587c8a535e1edc&services&callback=renderReverse&location=" + log2 + ',' + lat2 + "&output=json&pois=0";
                $.ajax({
                    type: "GET",
                    dataType: "jsonp",
                    url: url2,
