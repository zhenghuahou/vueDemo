...
$.fn.slider = function(config) {
    ...
    let description = b.find('.ks_warp').eq(0).find('img').data('title');
    
    if(description){
        title.html(description + ' ' + '1/' + box.length);
    }else{
    ...
    var toTitle = function(i) {
        ...
        let description = b.find('.ks_warp').eq(i).find('img').data('title');
        
        if(description){
            title.html(description + ' ' + (i + 1) + '/' + box.length);
        }else{
